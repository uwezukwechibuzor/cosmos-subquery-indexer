...
export class Account implements CompatEntity {
    ...
    constructor(
        ...
        this.totalTransactionsSent = totalTransactionsSent;
        this.totalTransactionsReceived = totalTransactionsReceived;
    ...
    public totalTransactionsSent: number;
    public totalTransactionsReceived: number;
    ...
    static create(record: AccountProps): Account {
        ...
        const entity = new this(
            ...
            record.totalTransactionsSent,
            record.totalTransactionsReceived,
        );
